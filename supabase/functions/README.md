...
| Function | Purpose |
| --- | --- |
| `trip-eta` | Traffic-aware ETA for a live trip via the Google Routes API (key server-side). See [docs/08_Database/TRIPS_AND_LIVE_TRACKING.md](../../docs/08_Database/TRIPS_AND_LIVE_TRACKING.md#eta-edge-function-trip-eta). |
...
```bash
supabase secrets set GOOGLE_MAPS_API_KEY=...   # Routes API enabled
```
