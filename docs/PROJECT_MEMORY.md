...
- **Legal:** privacy policy rewritten for real DPDP data flows + sole-prop entity.

## Key identifiers

- Apple Team ID `46CLB4HU9B` (individual enrollment).
- iOS bundle `in.co.caresy.app` · Apple Services ID `in.co.caresy.web`.
- Repo: `github.com/abhiiiiiisshek/caresy_phone`. Active branch `feature/structured-data`.
