  ...
  return (
    <main className="page" id="main-content">
      ...
      <section className="section" style={{ maxWidth: '900px', margin: '0 auto' }}>
        <Reveal style={{ borderRadius: 'var(--radius-xl)', overflow: 'hidden', boxShadow: 'var(--shadow-2)', background: 'var(--sage)', aspectRatio: '2.2', border: '1px solid var(--line)', marginBottom: 40 }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/assets/caresy-hero.webp" alt="Hospital support illustration" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </Reveal>

        <Stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
          {BENEFITS.map((b) => (
            <StaggerItem key={b.title} style={{ display: 'flex', gap: 14, alignItems: 'flex-start', padding: 18, borderRadius: 'var(--radius)', background: 'var(--surface)', border: '1px solid var(--line)' }}>
      ...
      <Reveal as="section" className="section" style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
        <Card>
