...
## Corpus Check
- 225 files · ~431,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1391 nodes · 1843 edges · 146 communities (94 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d888b1b`
...
### Community 0 - "Card"
Cohesion: 0.11
Nodes (20): ApprovedCompanion, BookingRecord, COLUMNS, initials(), OpsBoard(), OpsMetrics, STATUS_OPTIONS, ACTIVE_TRIP (+12 more)
...
Cohesion: 0.05
Nodes (55): metadata, poppins, viewport, AdminTopbar(), metadata, poppins, viewport, PortalHeader() (+47 more)
...
Cohesion: 0.17
Nodes (20): CollectPanel(), RunningTotal(), BillPanel(), LiveMeter(), applicableSlab(), billableMinutes(), cancellationPaise(), cancel() (+12 more)

### Community 25 - "route.ts"
Cohesion: 0.07
Nodes (32): CHECKLIST, FOUNDERS, BENEFITS, STEPS, TESTIMONIALS, Trust(), VERIFICATION_STEPS, useLiveMetrics() (+24 more)
...
### Community 47 - "Card"
Cohesion: 0.31
Nodes (7): AnalyticsBody(), MUTED_STATUSES, Stats, STATUS_ORDER, bookingRevenueRupees(), isBilled(), PricedBooking

### Community 48 - "Badge.tsx"
Cohesion: 0.28
Nodes (6): CompanionsBody(), DocRow, FILTERS, ReviewSheet(), STATUS_TONE, statusLabel()
...
Cohesion: 0.10
Nodes (17): CompanionRow, ApprovedDashboard(), CompanionPortal(), CompanionRow, DOC_TYPES, fmtWhen(), JobCard(), JobRow (+9 more)

### Community 80 - "README.md"
Cohesion: 0.14
Nodes (9): ADR-0001: Supabase (Postgres + RLS) is the backend; no custom API tier, Alternatives rejected, Consequences, Context, Decision, Architecture Decision Records, Deploy, Symptom index (+1 more)
...
Cohesion: 0.16
Nodes (17): AreasBody(), UserRow, UsersList(), LocationShare(), BadgeState, LocationBadge(), QUICK_PICKS, readStored() (+9 more)
...
Cohesion: 0.06
Nodes (29): epilogue, JSON_LD, metadata, poppins, viewport, CookieBanner(), APP_TABS, Header() (+21 more)
...
Cohesion: 0.13
Nodes (16): ACTIVE_STATUSES, fmtEta(), LiveBoard(), osmEmbed(), STATUS_LABEL, TripCard(), TripRow, FilterKey (+8 more)
...
Cohesion: 0.15
Nodes (11): ADR-0008: `assert`-based self-checks instead of a test framework, Alternatives rejected, Consequences, Context, Decision, If a key leaks, Known enforcement points, Open gaps (do not assume these are handled) (+3 more)
...
- **Why does `createClient()` connect `LocationBadge.tsx` to `Card`, `page.tsx`, `page.tsx`, `LocationBadge.tsx`, `page.tsx`, `layout.tsx`, `Card`, `Badge.tsx`, `page.tsx`, `next.config.ts`, `route.ts`, `InstallPrompt.tsx`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cookieOptionsFor()` connect `layout.tsx` to `LocationBadge.tsx`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `LocationBadge.tsx` to `Card`, `page.tsx`, `page.tsx`, `Badge.tsx`, `next.config.ts`, `InstallPrompt.tsx`, `page.tsx`?**
