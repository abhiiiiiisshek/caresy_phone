# Graph Report - caresy  (2026-08-27)

## Corpus Check
- 308 files · ~506,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2290 nodes · 3276 edges · 251 communities (155 shown, 96 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5caffd23`
...
7. `Session log — read this first, newest entry on top` - 18 edges
8. `expo` - 17 edges
9. `color` - 17 edges
10. `Booking()` - 17 edges
...
### Community 0 - "Button"
Cohesion: 0.09
Nodes (24): copyFor(), FILTERS, NotifBody(), NotifRow, NotifStatus, STATUS_COPY, STATUS_TONE, ACTIVE_TRIP (+16 more)
...
Cohesion: 0.15
Nodes (13): Booking(), CARE_NEEDS, fmtSlot(), label, LANGUAGES, SavedPatient, SERVICES, TRANSPORT_MODES (+5 more)
...
Cohesion: 0.06
Nodes (53): CollectPanel(), RunningTotal(), LiveMeter(), DURATIONS, BillPanel(), BookingRecord, BookingRow(), CHANGEABLE (+45 more)
...
Cohesion: 0.05
Nodes (29): enqueue_new_booking_notification, guard_companion_privileged_fields, guard_drive_assignment, guard_trip_status_columns, admin_users, companion_documents, companions, is_admin() (+21 more)
...
### Community 53 - "profile.tsx"
Cohesion: 0.12
Nodes (23): s, CareGuideDetail(), s, Profile, s, CATS, FAQS, s (+15 more)
...
Cohesion: 0.08
Nodes (33): CompanionsBody(), UsersList(), AdminTopbar(), ApprovedDashboard(), CompanionPortal(), directionsUrl(), DOC_TYPES, fmtWhen() (+25 more)
...
### Community 65 - "Reveal"
Cohesion: 0.14
Nodes (15): CHECKLIST, FOUNDERS, BENEFITS, STEPS, PRICE_POINTS, Services, Testimonials, Card() (+7 more)
...
Cohesion: 0.10
Nodes (21): AccountDelete(), a, FallbackGlyph, Home(), isTrackable(), NextBooking, Profile, s (+13 more)
...
Cohesion: 0.08
Nodes (25): 2026-08-13 — Agent 2 (Muse) — branch `feature/mobile-quick-help` (worktree: `Desktop/Caresy phone/caresy_m3_worktree`), 2026-08-13 — primary session — branch `feature/structured-data`, 2026-08-14 (evening) — primary session — branch `feature/mobile-quick-help` (worktree: `Desktop/Caresy phone/caresy_m3_worktree`), 2026-08-14 — Muse review — branch `feature/mobile-quick-help` (worktree: `caresy_m3_worktree`) — Phase 3 read, 2026-08-14 — primary + Muse — branch `feature/mobile-quick-help` — forward from Phase 3, 2026-08-14 — primary session — branch `feature/mobile-quick-help` (worktree: `Desktop/Caresy phone/caresy_m3_worktree`), 2026-08-21 — Muse — branch `feature/mobile-reschedule` (worktree: `caresy_reschedule_worktree`), 2026-08-21 — Muse — branch `feature/mobile-reschedule` (worktree: `caresy_reschedule_worktree`) — native picker v2 (+17 more)
...
### Community 88 - "ui.tsx"
Cohesion: 0.11
Nodes (19): AUD, CATS, GUIDE_META, s, BottomSheet(), bs, btn, Chip() (+11 more)
...
Cohesion: 0.13
Nodes (15): CARE_NEEDS, durationLabel(), DURATIONS, fmtSlot(), LANGUAGES, nextDays(), s, SavedPatient (+7 more)
...
### Community 111 - "family.tsx"
Cohesion: 0.18
Nodes (12): plugins, FamilyMember, FamilyScreen(), s, AuthContext, AuthContextValue, redirectTo, supabase (+4 more)
...
### Community 157 - "payments/page.tsx"
Cohesion: 0.12
Nodes (17): DrivingPanel(), ACTIVE_STATUSES, fmtEta(), LiveBoard(), osmEmbed(), STATUS_LABEL, TripCard(), TripRow (+9 more)
...
Cohesion: 0.08
Nodes (32): TERMS_SECTIONS, APP_TABS, Footer(), Badge(), BadgeProps, BadgeSize, BadgeTone, SIZES (+24 more)
...
Cohesion: 0.24
Nodes (6): Trust(), VERIFICATION_STEPS, Companion, COMPANIONS, matchCompanionByDepartment(), useLiveMetrics()
...
### Community 199 - "Troubleshooting & deployment playbook"
Cohesion: 0.67
Nodes (3): Deploy, Symptom index, Troubleshooting & deployment playbook

## Knowledge Gaps
- **1087 isolated node(s):** `SECURITY_HEADERS`, `nextConfig`, `name`, `version`, `private` (+1082 more)
...
- **Why does `AuthProvider()` connect `app/index.tsx` to `color`, `13_LIFECYCLE.sql`, `family.tsx`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
