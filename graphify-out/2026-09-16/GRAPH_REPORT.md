# Graph Report - caresy  (2026-09-09)

## Corpus Check
- 335 files · ~562,860 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2498 nodes · 3552 edges · 269 communities (174 shown, 95 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30404b47`
...
- `Stats` --references--> `BookingStatus`  [EXTRACTED]
  apps/admin/src/app/analytics/page.tsx → packages/types/src/index.ts
...
## Communities (269 total, 95 thin omitted)

### Community 0 - "payments/page.tsx"
Cohesion: 0.07
Nodes (33): copyFor(), FILTERS, NotifBody(), NotifRow, NotifStatus, STATUS_COPY, STATUS_TONE, ApprovedCompanion (+25 more)
...
### Community 8 - "src/pricing.ts"
Cohesion: 0.13
Nodes (21): DURATIONS, applicableSlab(), CANCELLATION_PAISE, cancellationPaise(), cancel(), p, url, EVENING_FROM_HOUR (+13 more)
...
Cohesion: 0.24
Nodes (13): InputProps, SpotVariant, EmptyState(), EmptyStateProps, ErrorState(), ErrorStateProps, LoadingState(), LoadingStateProps (+5 more)
...
### Community 55 - "companion/src/app/page.tsx"
Cohesion: 0.09
Nodes (20): Stats, CompanionRow, ApprovedDashboard(), CompanionRow, directionsUrl(), DOC_TYPES, fmtWhen(), JobCard() (+12 more)
...
### Community 75 - "0005-gatewayless-payments.md"
Cohesion: 0.33
...
### Community 88 - "ui.tsx"
Cohesion: 0.09
Nodes (32): AUD, CATS, GUIDE_META, s, s, CATS, FAQS, s (+24 more)

### Community 89 - "send-push/route.ts"
Cohesion: 0.07
Nodes (52): asciiOnly(), AttentionDecision, backoffMinutes(), dynamic, escalateStuckBookings(), fanoutTelegram(), flushDueDigestBuckets(), GET() (+44 more)
...
Cohesion: 0.07
Nodes (28): ACTIVE_TRIP, CARDS, Counts, OverviewBody(), CareEventForm(), KINDS, LocationShare(), requestWakeLock() (+20 more)
...
Cohesion: 0.21
Nodes (11): ETA_STATUSES, LocationPing, s, TrackedBooking, Tracking(), LoadingState(), shadow, trackingHeadline() (+3 more)
...
Cohesion: 0.10
Nodes (21): CARE_NEEDS, DURATIONS, LANGUAGES, s, SavedPatient, SERVICES, STEP_TITLES, TRANSPORT_MODES (+13 more)
...
Cohesion: 0.10
Nodes (29): AccountDelete(), s, plugins, FamilyMember, FamilyScreen(), s, BeautifulAuth(), handleEmailAuth() (+21 more)
...
Cohesion: 0.31
Nodes (7): public.complete_booking(), public.reschedule_booking(), pg_proc, public.open_job_pickups(), bookings, locations, auth.users
...
Cohesion: 0.19
Nodes (9): audit_bookings_changes, audit_bookings_changes, audit_logs, is_admin(), set_timestamp_bookings, set_timestamp_locations, set_timestamp_patients, trigger_set_timestamp (+1 more)

### Community 136 - "my-bookings.tsx"
Cohesion: 0.13
Nodes (24): BookingCard(), BookingRecord, isReschedulable(), isTrackable(), MyBookings(), patientName(), s, serviceLabel() (+16 more)
...
Cohesion: 0.12
Nodes (20): dynamic, POST(), CHIPS, FaqCategory, FAQS, Support(), supWa(), phoneFromVerifyResult() (+12 more)
...
Cohesion: 0.18
Nodes (11): Android release readiness — audit done, rebuild pending (2026-08-31), Before the first customer — in order, Current state, In flight, Known broken / blocked, Live in production (2026-08-02), Live tracking, remaining gap (2026-09-04), Needs a manual run (2026-09-08) (+3 more)
...
### Community 157 - "Button.tsx"
Cohesion: 0.29
Nodes (6): ButtonProps, ButtonShape, ButtonSize, ButtonVariant, SIZES, VARIANTS
...
### Community 159 - "canHover"
Cohesion: 0.15
Nodes (12): APP_TABS, Footer(), canHover(), CardProps, CardVariant, VARIANTS, IconButton(), IconButtonProps (+4 more)

### Community 160 - "Reveal.tsx"
Cohesion: 0.60
...
Cohesion: 0.13
Nodes (16): CompanionsBody(), DocRow, DrivingPanel(), FILTERS, ReviewSheet(), STATUS_TONE, statusLabel(), ACTIVE_STATUSES (+8 more)
...
### Community 186 - "sessionCrypto.check.ts"
Cohesion: 0.23
...
### Community 199 - "booking/page.tsx"
Cohesion: 0.08
Nodes (42): Booking(), durationLabel(), fmtSlot(), nextDays(), QuickHelp(), Booking(), CARE_NEEDS, fmtSlot() (+34 more)

### Community 203 - "dependencies"
Cohesion: 0.11
Nodes (19): dependencies, @caresy/types, @caresy/utils, expo-auth-session, expo-crypto, expo-device, expo-image-picker, expo-secure-store (+11 more)
...
### Community 210 - "useAuth"
Cohesion: 0.14
Nodes (11): AdminTopbar(), CompanionPortal(), RegistrationForm(), DeleteAccount(), Profile(), supWa(), TERMS_SECTIONS, MobileBottomNav() (+3 more)

### Community 212 - "TripStatusControl.tsx"
Cohesion: 0.40
Nodes (5): LABEL, NEXT, nextLabel(), TripStatus, TripStatusControl()
...
### Community 224 - "trust/page.tsx"
Cohesion: 0.15
Nodes (8): Trust(), VERIFICATION_STEPS, Companion, COMPANIONS, StatCard(), StatCardProps, StepItem(), StepItemProps
...
### Community 268 - "login/page.tsx"
Cohesion: 0.18
Nodes (8): btn(), ic, Login(), Step, Loop, LOOPS, MotionSpot(), SPOT

### Community 270 - "31_CUSTOMER_ACTIONS.sql"
Cohesion: 0.33
Nodes (4): guard_customer_booking_columns, public.cancel_booking(), public.reschedule_booking(), trg_guard_customer_booking

## Knowledge Gaps
- **1173 isolated node(s):** `SECURITY_HEADERS`, `nextConfig`, `name`, `version`, `private` (+1168 more)
...
- **Why does `AuthProvider()` connect `profile.tsx` to `ui.tsx`, `13_LIFECYCLE.sql`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `notifications` connect `13_LIFECYCLE.sql` to `bookings`, `profile.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `bookings` connect `bookings` to `public.stamp_companion_on_booking`, `SUPABASE_SCHEMA.sql`, `patients`, `31_CUSTOMER_ACTIONS.sql`, `10_ADMIN_AND_COMPANIONS.sql`, `13_LIFECYCLE.sql`, `26_BILLING.sql`?**
